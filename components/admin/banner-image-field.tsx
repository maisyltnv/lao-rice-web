  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        <label className="block text-sm font-medium">ຮູບ Banner *</label>
      ...
      {mode === "link" ? (
        ...
        <>
          <p className="text-xs text-muted-foreground">
            ເລືອຮູບ JPEG, PNG ຫຼື WebP ຈາກຄອມພິວເຕີ (ສູງສຸດ{" "}
            {Math.round(PRODUCT_IMAGE_MAX_BYTES / (1024 * 1024))} MB). ເມື່ອແກ້ໄຂ
            ແລະ ອັບໂຫຼດຮູບໃໝ່ ຮູບເກົ່າທີ່ເກັບໃນເຊີບເວີຈະຖືກລຶບອັດຕະໂນມັດ.
          </p>
          <input
            ref={inputRef}
            type="file"
